...
Class CPhaseMaker:
    ...
    def pint_model(self, model):
        #TODO: check that the model is an instance of pint model
    ...
    def _check_times(self, observation):
        ...
        if time_min < model_time_range.value or time_max > model_time_range.value:
            log.warning(f"At least one of the time of observation: {observation.obs_id} is outside of the validity range of the timing model")
        return time
